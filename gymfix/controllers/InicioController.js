...
export const InicioController = {
  ...
  _renderSeccionMotivacional(canEdit) {
    ...
    this._videos = [
      ...
      { tag: 'Nutrición', url: 'https://www.youtube.com/watch?v=ho5tVxBJWLA&t=338s', titulo: 'Alimentación para Deportistas', desc: 'Aprende qué comer antes y después de entrenar para mejores resultados.' },
    ]
    this._beneficios = [
