...
export const InicioController = {
  ...
  _renderSeccionMotivacional(canEdit) {
    ...
    this._videos = [
      ...
      { tag: 'Nutrición', url: 'https://www.youtube.com/embed/ho5tVxBJWLA', titulo: 'Alimentación para Deportistas', desc: 'Aprende qué comer antes y después de entrenar para mejores resultados.' },
    ]
    this._beneficios = [
